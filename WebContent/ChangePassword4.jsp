...
<div class="icon-bar">
  <a   class="active" href="account_profile.jsp"><i class="fa fa-home"></i><h4>My Account &amp; Profile</h4></a> 
  <a href="payment_transfer.jsp"><i class="fa fa-exchange"></i><h4>Payment / Transfer</h4></a> 
...
<h4 style="font-size: 36px; background-color: rgba(0,0,0,0.5);padding-left: 20px">Change Password</h4>
  <div style="color: red;background-color: rgba(0,0,255,0.1);margin-bottom: 20px;padding-left: 60px;margin-right: 30px"><b>
    				<%
...
<br>
    ...
    <div class="container_sub_form" style="background-color: rgba(172,17,1,0.3)">
    <h4>Kindly Visit Your nearest branch for assistance<br><br></h4>
    </div>
