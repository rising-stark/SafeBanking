...
<h4 style="font-size: 20px;padding-left: 20px;">Password Change</h4>
  ...
  <form action="passChangeOtp" method="post">
    <div class="row">
      <div class="col-25">
        <label for="fname"><h4>OTP:</h4></label>
      </div>
      <div class="col-75">
        <input type="text" id="fname" name="otp" placeholder="Enter the one time password">
      </div>
    </div>
